...
static bool SERCOM0_I2C_XferSetup(uint16_t address,
                                  uint8_t* wrData,
                                  uint32_t wrLength,
                                  uint8_t* rdData,
                                  uint32_t rdLength,
...
bool SERCOM0_I2C_Read(uint16_t address, uint8_t* rdData, uint32_t rdLength) {
    return SERCOM0_I2C_XferSetup(address, NULL, 0, rdData, rdLength,
                                 I2C_TRANSFER_READ, false);
}

bool SERCOM0_I2C_Write(uint16_t address, uint8_t* wrData, uint32_t wrLength) {
    return SERCOM0_I2C_XferSetup(address, wrData, wrLength, NULL, 0,
                                 I2C_TRANSFER_WRITE, false);
}

bool SERCOM0_I2C_WriteRead(uint16_t address,
                           uint8_t* wrData,
                           uint32_t wrLength,
                           uint8_t* rdData,
                           uint32_t rdLength) {
