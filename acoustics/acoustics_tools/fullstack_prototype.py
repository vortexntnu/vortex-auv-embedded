...
if __name__ == "__main__":
    ...
    parser.add_argument("--faulty", action="store_true", help="Introduce faults in TDOA for testing")
    args = parser.parse_args()

    store, results = run_capture(config_path=args.config, tdoa_method=args.tdoa_method, verbose=not args.quiet, hydrophone_data_path=args.hydrophone_data_path, inject_faulty_detection=args.faulty)
    if args.export:
