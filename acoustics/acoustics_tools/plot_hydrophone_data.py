...
def plot_mode(mode):
    ...
    if mode == 'Hydrophone 1 Only':
        ...
        freq = freq[freq > 0]  # Exclude zero frequency
        fft_values = np.fft.rfft(signal)
        fft_values = fft_values[1:]  # Exclude zero frequency
