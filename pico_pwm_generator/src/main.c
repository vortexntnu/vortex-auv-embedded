...
// TO DEFINE A DIFFERENT SDA OR SCL PIN OR A DIFFERENT I2C PORT, DEFINE IT HERE
// BEFORE INCLUDING THE "i2c.h" LIBRARY AS THAT DEFINES IT OWN DEFAULT ONES
// OTHERWISE #define I2C_SDA  <enter_gpio_pin> #define I2C_SCL  <enter_gpio_pin>
