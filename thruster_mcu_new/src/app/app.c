...
static struct pwm_output thrusters[8] = {
    {1, 0, TCC0_PERIOD, 1000, 2000, 1500, THRUSTER_PWM_PERIOD_US}, // TCC1_CC0
    {1, 1, TCC0_PERIOD, 1000, 2000, 1500, THRUSTER_PWM_PERIOD_US}, // TCC1_CC1
    ...
    {2, 0, TCC1_PERIOD, 1000 ,2000, 1500, THRUSTER_PWM_PERIOD_US}, // TCC2_CC0
    {2, 1, TCC1_PERIOD, 1000 ,2000, 1500, THRUSTER_PWM_PERIOD_US}  // TCC2_CC1
};
