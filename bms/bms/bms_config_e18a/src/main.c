...
// *****************************************************************************
// *****************************************************************************
static void CAN_Wake_EIC_Callback(uintptr_t context) // called when a CAN wake-up interrupt occurs on EIC pin 11
{
    (void)context;
    sm_on_can_wake();
}
...
int main ( void )
{
    ...
    RTC_Timer32Start();
    EIC_CallbackRegister(EIC_PIN_11, CAN_Wake_EIC_Callback, 0); 
